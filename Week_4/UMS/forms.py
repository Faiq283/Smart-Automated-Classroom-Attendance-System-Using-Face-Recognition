...
from .models import CustomUser, University, Campus, Department, Program, Course, Semester, SemCourses
import random
import string
...
class SemesterForm(forms.ModelForm):
    ...
    def clean(self):
        ...
        if Semester.objects.filter(semester_name=semester_name, start_date=start_date).exists():
            raise forms.ValidationError("A semester with this name and start date already exists.")
